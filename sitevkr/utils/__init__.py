...
def calc_day_by_hours(data, num_month, num_day_m, latitude=0, tilt_angle=0, azimuth=0):
...
# поиск угла при котором выроботка максимальна (день, месяц, год или произвольный период)
